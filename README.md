...
### Backend 
- [python-workflow.md](python-workflow.md) - General Python development, tooling, and environments
...
- [validate-workflows.sh](scripts/validate-workflows.sh) - Validate workflow structure and links
- [generate-project.sh](scripts/generate-project.sh) - Bootstrap new projects from templates
- [check-dependencies.sh](scripts/check-dependencies.sh) - Verify required tools are installed
- [update-workflows.sh](scripts/update-workflows.sh) - Batch update workflow versions

### `/templates/` - Project Templates
- [python-project/](templates/python-project/) - Standard Python project structure
- [nodejs-project/](templates/nodejs-project/) - Node.js project template
- [docker-compose/](templates/docker-compose/) - Docker Compose configurations
- [ci-cd-templates/](templates/ci-cd-templates/) - CI/CD pipeline templates

### `/examples/` - Example Configurations
- [docker-compose-examples/](examples/docker-compose-examples/) - Sample Docker Compose files
- [github-actions/](examples/github-actions/) - GitHub Actions workflow examples
- [kubernetes-manifests/](examples/kubernetes-manifests/) - K8s YAML examples
- [terraform-modules/](examples/terraform-modules/) - Terraform module examples

### `/assets/` - Supporting Files
- [diagrams/](assets/diagrams/) - Workflow diagrams and architecture images
- [cheatsheets/](assets/cheatsheets/) - Quick reference cheat sheets
- [icons/](assets/icons/) - Technology icons for documentation
